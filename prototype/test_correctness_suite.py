...
class TestNumericalCorrectness:
    ...
    def test_toymodel_small_layers(self):
        ...
        assert np.allclose(baseline, distributed, rtol=1e-5, atol=1e-7), \
    ...
    def test_three_way_split(self):
        ...
        assert np.allclose(baseline, current, rtol=1e-5, atol=1e-7), \
    ...
    def test_edge_case_large_input(self):
        ...
        assert np.allclose(baseline, distributed, rtol=1e-4, atol=1e-6), \
    ...
    def test_layer_boundary_activations(self):
        ...
        assert np.allclose(distributed, out, rtol=1e-5, atol=1e-7), \
    ...
    def test_numerical_precision_fp32(self):
        ...
        assert max_diff < 100 * fp32_epsilon, \
...
class TestPartitionConsistency:
    ...
    def test_static_partition_vs_dynamic(self):
        ...
        assert np.allclose(static_result, distributed_forward(model, x, num_slices=2), 
                          rtol=1e-5, atol=1e-7)
    ...
    def test_slice_order_independence(self):
        ...
        try:
            ...
            assert not np.allclose(result_normal, result_reversed), \
