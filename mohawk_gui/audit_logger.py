...
class AuditLogger:
    ...
    def get_events(
        self, event_type: str = None, resource: str = None, since: str = None
    ) -> list:
        """
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        stats = {"total_events": 0, "by_category": {}, "by_action_type": {}}
...
if __name__ == "__main__":
    ...
    logger.log_action(
        action_type="read", resource="config.toml", details={}, user_id="admin"
    )
