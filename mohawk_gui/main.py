...
The dashboard includes:
  ...
  - Conversation History
    ...
    parser.add_argument(
        "--port", type=int, default=8003, help="Port to listen on (default: 8003)"
    )

    parser.add_argument(
        "--key-file", default=None, help="Path to authentication key file"
    )

    parser.add_argument(
        "--ssl-enabled", action="store_true", help="Enable SSL/TLS for connections"
    )
