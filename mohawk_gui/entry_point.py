...
def main():
    ...
    parser.add_argument(
        "--host", default="localhost", help="Worker host (default: localhost)"
    )
    parser.add_argument(
        "--port", type=int, default=8003, help="Worker port (default: 8003)"
    )
    parser.add_argument(
        "--config", default="config.toml", help="Configuration file path"
    )
